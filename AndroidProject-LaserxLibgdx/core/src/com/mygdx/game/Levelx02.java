...
public class Levelx02 extends Levelx {
    ...
    public void addObstacles() {
        ...
        getObstacles()[1] = new Obstacle(Math.min(Gdx.graphics.getHeight()*(0.1f),Gdx.graphics.getWidth()*(0.15f))/2f,getSquares()[0].getX(),
                getSquares()[0].getY(),"asteroid.png");
